...
public class SSBottomsheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public static final int STATE_ANCHORED = 7;
    ...
    public SSBottomsheetBehavior() {}

    public SSBottomsheetBehavior(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @NonNull SSBottomsheetBehavior<?> behavior) {
            super(superState);
