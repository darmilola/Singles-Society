...
public class ChatModel {
    ...
    private ArrayList<com.aure.UiModels.Message> messageArrayList = new ArrayList<>();
    ...
    public interface ChatGetMessageListener{
        void onMessageReady(ArrayList<com.aure.UiModels.Message> messageArrayList, String nextPageUrl, int total);
        void onError(String message);
    }
            ...
            try {
                ...
                if(status.equalsIgnoreCase("success")){
                    ...
                    for(int i = 0; i < data.length(); i++){
                        ...
                        com.aure.UiModels.Message message = new com.aure.UiModels.Message(user, StringEscapeUtils.unescapeJava(mMessage),date);
                        if(!imageUrl.equalsIgnoreCase("null")){
                            message.setImage(new com.aure.UiModels.Message.Image(imageUrl));
                        }
