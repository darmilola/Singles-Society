...
public class PlayableCardStackView extends PlayableItemsRecyclerView  {

    private final CardStackDataObserver observer = new CardStackDataObserver(this);

    public PlayableCardStackView(Context context) {
        this(context, null);
    }

    public PlayableCardStackView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PlayableCardStackView(Context context, @Nullable AttributeSet attrs, int defStyle) {
