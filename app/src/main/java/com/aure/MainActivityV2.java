...
public class MainActivityV2 extends AppCompatActivity {
    ...
    private ArrayList<SSCustomBottomNavigation.Model> populateBottombar(){
        ...
        SSCustomBottomNavigation.Model main2 = new SSCustomBottomNavigation.Model(2,R.drawable.about,"Chat");
        SSCustomBottomNavigation.Model main3 = new SSCustomBottomNavigation.Model(3,R.drawable.love,"Chat");
        SSCustomBottomNavigation.Model main4 = new SSCustomBottomNavigation.Model(4,R.drawable.cancel_icon,"Chat");
