...
final class PausableProgressBar extends FrameLayout {
    ...
    void setMinWithoutCallback() {
        maxProgressView.setBackgroundResource(R.drawable.stories_bg_back);
    ...
    void setMaxWithoutCallback() {
        maxProgressView.setBackgroundResource(R.drawable.story_bg_front);
    ...
    private void finishProgress(boolean isMax) {
        if (isMax) maxProgressView.setBackgroundResource(R.drawable.story_bg_front);
