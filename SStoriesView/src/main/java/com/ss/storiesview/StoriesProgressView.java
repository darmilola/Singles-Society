...
public class StoriesProgressView extends LinearLayout {
    ...
    private final LayoutParams SPACE_LAYOUT_PARAM = new LayoutParams(30, LayoutParams.WRAP_CONTENT);
    ...
    public void restartStories(int from) {
        for (int i = 0; i < progressBars.size(); i++) {
            if(i < from){
                progressBars.get(i).setMaxWithoutCallback();
            }
